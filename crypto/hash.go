...
// Gets the SSH fingerprint using the MD5 algorithm. The format will be the same as on Github.
...
// Generate a hash output which is exactly the same as the one that will be generated by IPFS.
